...
rearrange <- function(fit){
  ...
  Mat_RowOrder1 = cbind(fit$X1.joint[[1]]+fit$X1.row[[1]], fit$X1.joint[[2]]+fit$X1.row[[2]]) 
  Mat_RowOrder2 = cbind(fit$X2.joint[[1]]+fit$X2.row[[1]], fit$X2.joint[[2]]+fit$X2.row[[2]]) 
  
  Mat_ColOrder1 = rbind(fit$X1.joint[[1]]+fit$X1.col[[1]], fit$X2.joint[[1]]+fit$X2.col[[1]]) 
  Mat_ColOrder2 = rbind(fit$X1.joint[[2]]+fit$X1.col[[2]], fit$X2.joint[[2]]+fit$X2.col[[2]]) 
  ...
  Image_Joint1[[1]] = as.matrix(fit$X1.joint[[1]][row.orders[[1]],col.orders[[1]]]) 
  Image_Joint1[[2]] = as.matrix(fit$X1.joint[[2]][row.orders[[1]],col.orders[[2]]]) 
  Image_Joint2[[1]] = as.matrix(fit$X2.joint[[1]][row.orders[[2]],col.orders[[1]]]) 
  Image_Joint2[[2]] = as.matrix(fit$X2.joint[[2]][row.orders[[2]],col.orders[[2]]]) 
...
BIDsim = function(n=100, m=100, rkJ=1, rkC=c(1,1), rkR=c(1,1), rkI=c(1,1,1,1), SNR=1){
  ...
  # rkJ  : rank of jointly-shared components
  ...
  rk=2*rkJ+2*sum(rkC)+2*sum(rkR)+sum(rkI)
  ...
  rk11=rkJ+rkC1+rkR1+rkI11
  rk12=rkJ+rkC2+rkR1+rkI12
  rk21=rkJ+rkC1+rkR2+rkI21
  rk22=rkJ+rkC2+rkR2+rkI22
  ...
  csumC=cumsum(c(rep(rkJ,2),rep(rkC,2),rkR,rkI))
  csumC1=csumC+1
  csumR=cumsum(c(rep(rkJ,2),rkC,rep(rkR,2),rkI))
  csumR1=csumR+1
  ...
  if (rkJ>0){
    index.J.u10=index.u[1:csumR[1]]
    index.J.u20=index.u[csumR1[1]:csumR[2]]
    index.J.v01=index.v[1:csumC[1]]
    index.J.v02=index.v[csumC1[1]:csumC[2]]
  }
  else{
    index.J.u10=index.J.u20=index.J.v01=index.J.v02=NULL
  }
  ...
  if(rk == 0){
    ...
    index.u.X11=c(index.J.u10,index.C.u11,index.R.u10,index.I.u11);
    index.u.X12=c(index.J.u10,index.C.u12,index.R.u10,index.I.u12);
    index.u.X21=c(index.J.u20,index.C.u21,index.R.u20,index.I.u21);
    index.u.X22=c(index.J.u20,index.C.u22,index.R.u20,index.I.u22);
    
    index.v.X11=c(index.J.v01,index.C.v01,index.R.v11,index.I.v11);
    index.v.X12=c(index.J.v01,index.C.v02,index.R.v12,index.I.v12);
    index.v.X21=c(index.J.v02,index.C.v01,index.R.v21,index.I.v21);
    index.v.X22=c(index.J.v02,index.C.v02,index.R.v22,index.I.v22);
    
    samp.J.X11=sample(rk, rkJ)
    samp.J.X12=sample(rk, rkJ)
    samp.J.X21=sample(rk, rkJ)
    samp.J.X22=sample(rk, rkJ)
    ...
    samp.X11=c(samp.J.X11,samp.C.X11,samp.R.X11, samp.I.X11)
    samp.X12=c(samp.J.X12,samp.C.X12,samp.R.X11, samp.I.X12)
    samp.X21=c(samp.J.X21,samp.C.X21,samp.R.X11, samp.I.X21)
    samp.X22=c(samp.J.X22,samp.C.X22,samp.R.X11, samp.I.X22)
    
    J11=svd.signal$u[, index.J.u10,drop=F] %*% diag(svd.signal$d[samp.J.X11], rkJ, rkJ) %*% t(svd.signal$v[, index.J.v01, drop=F])/ sqrt(sum(svd.signal$d[samp.X11]^2))
    J12=svd.signal$u[, index.J.u10,drop=F] %*% diag(svd.signal$d[samp.J.X12], rkJ, rkJ) %*% t(svd.signal$v[, index.J.v02, drop=F])/ sqrt(sum(svd.signal$d[samp.X12]^2))
    J21=svd.signal$u[, index.J.u20,drop=F] %*% diag(svd.signal$d[samp.J.X21], rkJ, rkJ) %*% t(svd.signal$v[, index.J.v01, drop=F])/ sqrt(sum(svd.signal$d[samp.X21]^2))
    J22=svd.signal$u[, index.J.u20,drop=F] %*% diag(svd.signal$d[samp.J.X22], rkJ, rkJ) %*% t(svd.signal$v[, index.J.v02, drop=F])/ sqrt(sum(svd.signal$d[samp.X22]^2))
  ...
  return(list(X = list(X11,X12,X21,X22), S = list(S11,S12,S21,S22), 
              J = list(J11,J12,J21,J22), C= list(C11,C12,C21,C22),
...
generateRank=function(rk=10, on.list=rep(1,4), minrk.list=rep(1,4)){
  ...
  #          the first element=0 enforces rkJ to be 0
  ...
  return(list(rkJ=x[1], rkR=x[2], rkC=x[3], rkI=x[4]))
}




BIDIFAC.als<-function(X1,X2, noise.est="RMT", sigma1=NULL, sigma2=NULL,
  ...
  lambda.G=sqrt(n1+n2)+sqrt(m1+m2)
  ...
  count<-1
  if (is.null(start)){
    U1.J<-generateRandomMatrix(n1,rkJ,gpu=gpu)#, ...) ;
    ...
    U2.J<-generateRandomMatrix(n2,rkJ,gpu=gpu)#, ...);
    ...
    V1.J<-generateRandomMatrix(m1,rkJ,gpu=gpu)#, ...);
    ...
    V2.J<-generateRandomMatrix(m2,rkJ,gpu=gpu)#, ...);
  ...
  pred11.J=pred11.C=pred11.R=pred11.I=
    pred12.J=pred12.C=pred12.R=pred12.I=
    pred21.J=pred21.C=pred21.R=pred21.I=
    pred22.J=pred22.C=pred22.R=pred22.I=0
  ...
  while (bool){
    ...
    pred11.J.old = pred11.J; pred11.R.old = pred11.R; pred11.C.old = pred11.C; pred11.I.old = pred11.I
    pred12.J.old = pred12.J; pred12.R.old = pred12.R; pred12.C.old = pred12.C; pred12.I.old = pred12.I
    pred21.J.old = pred21.J; pred21.R.old = pred21.R; pred21.C.old = pred21.C; pred21.I.old = pred21.I
    pred22.J.old = pred22.J; pred22.R.old = pred22.R; pred22.C.old = pred22.C; pred22.I.old = pred22.I
    
    #Update V1.J and V2.J
    ...
    V1.J = myridge(rbind(U1.J, U2.J), Y, lambda.G, transpose = T)
    ...
    V2.J = myridge(rbind(U1.J, U2.J),Y, lambda.G, transpose = T)
    ...
    U1.J = myridge(rbind(V1.J, V2.J), Y, lambda.G, transpose = T)
    ...
    U2.J = myridge(rbind(V1.J, V2.J),Y, lambda.G, transpose = T)
    
    #Update V1.C and V2.C
    Y = rbind(X11-tcrossprod(U1.J,V1.J)-tcrossprod(U1.R, V11.R) - tcrossprod(U11.I,V11.I),
              X21-tcrossprod(U2.J,V1.J)-tcrossprod(U2.R, V21.R)-tcrossprod(U21.I,V21.I))
    V1.C = myridge(rbind(U11.C, U21.C), Y, lambda1.C, transpose = T)
    
    Y = rbind(X12-tcrossprod(U1.J,V2.J)-tcrossprod(U1.R, V12.R)-tcrossprod(U12.I,V12.I),
              X22-tcrossprod(U2.J,V2.J)-tcrossprod(U2.R, V22.R)-tcrossprod(U22.I,V22.I))
    V2.C = myridge(rbind(U12.C, U22.C), Y, lambda2.C, transpose = T)
    
    #Update U11.C, U12.C, U21.C, U22.C
    Y = X11.t-tcrossprod(V1.J,U1.J)-tcrossprod(V11.R, U1.R)-tcrossprod(V11.I,U11.I)
    U11.C = myridge(V1.C, Y, lambda1.C, transpose = T)
    
    Y = X12.t-tcrossprod(V2.J,U1.J)-tcrossprod(V12.R, U1.R)-tcrossprod(V12.I,U12.I)
    U12.C = myridge(V2.C, Y, lambda2.C, transpose = T)
    
    Y = X21.t-tcrossprod(V1.J,U2.J)-tcrossprod(V21.R, U2.R)-tcrossprod(V21.I,U21.I)
    U21.C = myridge(V1.C,Y, lambda1.C, transpose = T)
    
    Y = X22.t-tcrossprod(V2.J,U2.J)-tcrossprod(V22.R, U2.R)-tcrossprod(V22.I,U22.I)
    U22.C = myridge(V2.C, Y, lambda2.C, transpose = T)
    
    #Update V11.R, V12.R, V21.R, V22.R
    Y = X11-tcrossprod(U1.J,V1.J)-tcrossprod(U11.C,V1.C)-tcrossprod(U11.I,V11.I)
    V11.R = myridge(U1.R, Y, lambda1.R, transpose = T)
    
    Y = X12-tcrossprod(U1.J,V2.J)-tcrossprod(U12.C,V2.C)-tcrossprod(U12.I,V12.I)
    V12.R = myridge(U1.R, Y, lambda1.R, transpose = T)
    
    Y = X21-tcrossprod(U2.J,V1.J)-tcrossprod(U21.C,V1.C)-tcrossprod(U21.I,V21.I)
    V21.R = myridge(U2.R, Y, lambda2.R, transpose = T)
    
    Y = X22-tcrossprod(U2.J,V2.J)-tcrossprod(U22.C,V2.C)-tcrossprod(U22.I,V22.I)
    V22.R = myridge(U2.R, Y, lambda2.R, transpose = T)
    
    #Update U1.R and U2.R
    Y = rbind(X11.t-tcrossprod(V1.J,U1.J)-tcrossprod(V1.C,U11.C)-tcrossprod(V11.I,U11.I),
              X12.t-tcrossprod(V2.J,U1.J)-tcrossprod(V2.C,U12.C)-tcrossprod(V12.I,U12.I))
    U1.R = myridge(rbind(V11.R, V12.R), Y, lambda1.R, transpose = T)
    
    Y = rbind(X21.t-tcrossprod(V1.J,U2.J)-tcrossprod(V1.C,U21.C)-tcrossprod(V21.I,U21.I),
              X22.t-tcrossprod(V2.J,U2.J)-tcrossprod(V2.C,U22.C)-tcrossprod(V22.I,U22.I))
    U2.R = myridge(rbind(V21.R, V22.R),Y, lambda2.R, transpose = T)
    
    #Update V11.I, V12.I, V21.I, and V22.I
    Y = X11-tcrossprod(U1.J,V1.J)-tcrossprod(U1.R, V11.R)-tcrossprod(U11.C,V1.C)
    V11.I = myridge(U11.I,Y, lambda11.I, transpose = T)
    
    Y = X12-tcrossprod(U1.J,V2.J)-tcrossprod(U1.R, V12.R)-tcrossprod(U12.C,V2.C)
    V12.I = myridge(U12.I, Y, lambda12.I, transpose = T)
    
    Y = X21-tcrossprod(U2.J,V1.J)-tcrossprod(U2.R, V21.R)-tcrossprod(U21.C,V1.C)
    V21.I = myridge(U21.I, Y, lambda21.I, transpose = T)
    
    Y = X22-tcrossprod(U2.J,V2.J)-tcrossprod(U2.R, V22.R)-tcrossprod(U22.C,V2.C)
    V22.I = myridge(U22.I, Y, lambda22.I, transpose = T)
    
    #Update U11.I, U12.I, U21.I, and U22.I
    Y = X11.t-tcrossprod(V1.J,U1.J)-tcrossprod(V11.R, U1.R)-tcrossprod(V1.C,U11.C)
    U11.I = myridge(V11.I, Y, lambda11.I, transpose = T)
    
    Y = X12.t-tcrossprod(V2.J,U1.J)-tcrossprod(V12.R, U1.R)-tcrossprod(V2.C,U12.C)
    U12.I = myridge(V12.I, Y, lambda12.I, transpose = T)
    
    Y = X21.t-tcrossprod(V1.J,U2.J)-tcrossprod(V21.R, U2.R)-tcrossprod(V1.C,U21.C)
    U21.I = myridge(V21.I,Y, lambda21.I, transpose = T)
    
    Y = X22.t-tcrossprod(V2.J,U2.J)-tcrossprod(V22.R, U2.R)-tcrossprod(V2.C,U22.C)
    U22.I = myridge(V22.I,Y, lambda22.I, transpose = T)
    
    pred11.J = tcrossprod(U1.J,V1.J); pred11.I = tcrossprod(U11.I,V11.I); pred11.R = tcrossprod(U1.R,V11.R); pred11.C = tcrossprod(U11.C,V1.C); pred11 = pred11.J+pred11.C+pred11.R+pred11.I
    pred12.J = tcrossprod(U1.J,V2.J); pred12.I = tcrossprod(U12.I,V12.I); pred12.R = tcrossprod(U1.R,V12.R); pred12.C = tcrossprod(U12.C,V2.C); pred12 = pred12.J+pred12.C+pred12.R+pred12.I
    pred21.J = tcrossprod(U2.J,V1.J); pred21.I = tcrossprod(U21.I,V21.I); pred21.R = tcrossprod(U2.R,V21.R); pred21.C = tcrossprod(U21.C,V1.C); pred21 = pred21.J+pred21.C+pred21.R+pred21.I
    pred22.J = tcrossprod(U2.J,V2.J); pred22.I = tcrossprod(U22.I,V22.I); pred22.R = tcrossprod(U2.R,V22.R); pred22.C = tcrossprod(U22.C,V2.C); pred22 = pred22.J+pred22.C+pred22.R+pred22.I
    
    
    crit0 = frob(X11-pred11)+frob(X12-pred12)+frob(X21-pred21)+frob(X22-pred22)+
      lambda11.I*(frob(U11.I)+frob(V11.I) )+
      lambda12.I*(frob(U12.I)+frob(V12.I) )+
      lambda21.I*(frob(U21.I)+frob(V21.I) )+
      lambda22.I*(frob(U22.I)+frob(V22.I) )+
      lambda1.C*(frob(V1.C)+frob(U11.C)+frob(U21.C))+
      lambda2.C*(frob(V2.C)+frob(U12.C)+frob(U22.C))+
      lambda1.R*(frob(U1.R)+frob(V11.R)+frob(V12.R))+
      lambda2.R*(frob(U2.R)+frob(V21.R)+frob(V22.R))+
      lambda.G*(frob(V1.J)+frob(V2.J)+frob(U1.J)+frob(U2.J))
  ...
  if (out){
    U.out=list(U1.J, U1.R, U11.C, U12.C, U11.I, U12.I, U2.J, U2.R, U21.C, U22.C, U21.I, U22.I)
    V.out=list(V1.J, V11.R, V21.R, V1.C, V11.I, V21.I, V2.J, V12.R, V22.R, V2.C, V12.I, V22.I)
    out=list(U.out, V.out)
  }
  else{
    out=NULL    
  }
  ...
  return(list(X1.original=list(X11.original, X12.original),
              ...
              X1.joint=list(pred11.J, pred12.J),
              X2.joint=list(pred21.J, pred22.J),
...
BIDIFAC.nuclear<-function(X1,X2, noise.est="RMT", sigma1=NULL, sigma2=NULL,
                          start=NULL, out=FALSE,
                          eps=1e-5, max.iter=1000, gpu=FALSE, pbar=TRUE, seed=NULL, ...){
  #It fits BID.jive to the bidimensionally linked matrices X1=(X11,X12), X2=(X21,X22)
  #noise.RMT: if TRUE, BID.jive() detects noise variance by random matrix theory
  ...
  X11 = X11.original/sigma11; 
  X12 = X12.original/sigma12; 
  X21 = X21.original/sigma21; 
  X22 = X22.original/sigma22; 
  
  X10=cbind(X11,X12); X20=cbind(X21,X22)
  X01=rbind(X11,X21); X02=rbind(X12,X22)
  X00=cbind(X01, X02)
  ...
  if (!is.null(start)){
    ...
    J00.new=generateRandomMatrix(n1+n2,m1+m2,gpu=F)
    R10.new=generateRandomMatrix(n1,m1+m2,gpu=F)
    R20.new=generateRandomMatrix(n2,m1+m2,gpu=F)
    C01.new=generateRandomMatrix(n1+n2,m1,gpu=F)
    C02.new=generateRandomMatrix(n1+n2,m2,gpu=F)
    I11.new=generateRandomMatrix(n1,m1,gpu=F)
    I12.new=generateRandomMatrix(n1,m2,gpu=F)
    I21.new=generateRandomMatrix(n2,m1,gpu=F)
    I22.new=generateRandomMatrix(n2,m2,gpu=F)
  }
  
  J10.new=J00.new[1:n1,]; J20.new=J00.new[-(1:n1),]
  J01.new=J00.new[,1:m1]; J02.new=J00.new[,-(1:m1)]
  J11.new=J10.new[,1:m1]; J12.new=J10.new[,-(1:m1)]
  J21.new=J20.new[,1:m1]; J22.new=J20.new[,-(1:m1)]
  
  C00.new=cbind(C01.new, C02.new)
  C11.new=C01.new[1:n1,]; C21.new=C01.new[-(1:n1),]
  C12.new=C02.new[1:n1,]; C22.new=C02.new[-(1:n1),]
  C10.new=cbind(C11.new, C12.new)
  C20.new=cbind(C21.new, C22.new)
  
  R00.new=rbind(R10.new, R20.new)
  R11.new=R10.new[,1:m1]; R12.new=R10.new[,-(1:m1)]
  R21.new=R20.new[,1:m1]; R22.new=R20.new[,-(1:m1)]
  R01.new=rbind(R11.new,R21.new)
  R02.new=rbind(R12.new,R22.new)
  
  I10.new=cbind(I11.new, I12.new)
  I20.new=cbind(I21.new, I22.new)
  I01.new=rbind(I11.new, I21.new)
  I02.new=rbind(I12.new, I22.new)
  I00.new=cbind(I01.new, I02.new)
  ...
  while (bool){
    ...
    #Update I
    svd.I11=svd(X11-J11.new-C11.new-R11.new)
    svd.I12=svd(X12-J12.new-C12.new-R12.new)
    svd.I21=svd(X21-J21.new-C21.new-R21.new)
    svd.I22=svd(X22-J22.new-C22.new-R22.new)
    
    d.I11=pmax(svd.I11$d-lambda11.I,0)
    d.I12=pmax(svd.I12$d-lambda12.I,0)
    d.I21=pmax(svd.I21$d-lambda21.I,0)
    d.I22=pmax(svd.I22$d-lambda22.I,0)
    
    I11.new=svd.I11$u%*%diag(d.I11)%*%t(svd.I11$v)
    I12.new=svd.I12$u%*%diag(d.I12)%*%t(svd.I12$v)
    I21.new=svd.I21$u%*%diag(d.I21)%*%t(svd.I21$v)
    I22.new=svd.I22$u%*%diag(d.I22)%*%t(svd.I22$v)
    
    I10.new=cbind(I11.new, I12.new)
    I20.new=cbind(I21.new, I22.new)
    I01.new=rbind(I11.new, I21.new)
    I02.new=rbind(I12.new, I22.new)
    I00.new=rbind(I10.new, I20.new)
    
    #Update R
    svd.R10=svd(X10-J10.new-C10.new-I10.new)
    svd.R20=svd(X20-J20.new-C20.new-I20.new)
    
    d.R10=pmax(svd.R10$d-lambda1.R,0)
    d.R20=pmax(svd.R20$d-lambda2.R,0)
    
    R10.new=svd.R10$u%*%diag(d.R10)%*%t(svd.R10$v)
    R20.new=svd.R20$u%*%diag(d.R20)%*%t(svd.R20$v)
    R00.new=rbind(R10.new, R20.new)
    R11.new=R10.new[,1:m1]; R12.new=R10.new[,-(1:m1)]
    R21.new=R20.new[,1:m1]; R22.new=R20.new[,-(1:m1)]
    R01.new=rbind(R11.new, R21.new)
    ...
    #Update C
    svd.C01=svd(X01-J01.new-R01.new-I01.new)
    svd.C02=svd(X02-J02.new-R02.new-I02.new)
    
    d.C01=pmax(svd.C01$d-lambda1.C,0)
    d.C02=pmax(svd.C02$d-lambda2.C,0)
    
    C01.new=svd.C01$u%*%diag(d.C01)%*%t(svd.C01$v)
    C02.new=svd.C02$u%*%diag(d.C02)%*%t(svd.C02$v)
    C00.new=cbind(C01.new, C02.new)
    C10.new=C00.new[1:n1,]
    C20.new=C00.new[-(1:n1),]
    C11.new=C10.new[,1:m1]
    C12.new=C10.new[,-(1:m1)]
    C21.new=C20.new[,1:m1]
    C22.new=C20.new[,-(1:m1)]
    
    #Update J
    svd.J00=svd(X00-C00.new-R00.new-I00.new)
    d.J00=pmax(svd.J00$d-lambda.G,0)
    
    J00.new=svd.J00$u%*%diag(d.J00)%*%t(svd.J00$v)
    J01.new=J00.new[,1:m1]
    J02.new=J00.new[,-(1:m1)]
    J10.new=J00.new[1:n1,]
    J20.new=J00.new[-(1:n1),]
    J11.new=J10.new[,1:m1]
    J12.new=J10.new[,-(1:m1)]
    J21.new=J20.new[,1:m1]
    J22.new=J20.new[,-(1:m1)]
    
    pred11=J11.new+R11.new+C11.new+I11.new
    pred12=J12.new+R12.new+C12.new+I12.new
    pred21=J21.new+R21.new+C21.new+I21.new
    pred22=J22.new+R22.new+C22.new+I22.new
    
    crit0 = frob(X11-pred11)+frob(X12-pred12)+frob(X21-pred21)+frob(X22-pred22)+
      2*(lambda11.I*sum(d.I11)+lambda12.I*sum(d.I12)+lambda21.I*sum(d.I21)+lambda22.I*sum(d.I22))+
      2*(lambda1.C*sum(d.C01)+lambda2.C*sum(d.C02))+
      2*(lambda1.R*sum(d.R10)+lambda2.R*sum(d.R20))+
      2*lambda.G*sum(d.J00)
  ...
  if (out==T){
    J.out=J00.new
    R.out=list(R10.new, R20.new)
    C.out=list(C01.new, C02.new)
    I.out=list(I11.new, I12.new, I21.new, I22.new)
    out=list(J.out, R.out, C.out, I.out)
  } else{
    out=NULL
  } 
  ...
  pred11 = pred11*sigma11
  pred11.J = J11.new*sigma11
  pred11.C = C11.new*sigma11
  pred11.R = R11.new*sigma11
  pred11.I = I11.new*sigma11
  
  pred12 = pred12*sigma12
  pred12.J = J12.new*sigma12
  pred12.C = C12.new*sigma12
  pred12.R = R12.new*sigma12
  pred12.I = I12.new*sigma12
  
  pred21 = pred21*sigma21
  pred21.J = J21.new*sigma21
  pred21.C = C21.new*sigma21
  pred21.R = R21.new*sigma21
  pred21.I = I21.new*sigma21
  
  pred22 = pred22*sigma22
  pred22.J = J22.new*sigma22
  pred22.C = C22.new*sigma22
  pred22.R = R22.new*sigma22
  pred22.I = I22.new*sigma22
...
BIDIFAC<-function(X1,X2, noise.est="RMT", sigma1=NULL, sigma2=NULL,
                  start=NULL, out=FALSE, method="nuclear",
                  eps=1e-5, max.iter=1000, gpu=FALSE, pbar=TRUE, seed=NULL, ...){
  if (method=="nuclear"){
    fit=BIDIFAC.nuclear(X1=X1,X2=X2,noise.est=noise.est, sigma1=sigma1,sigma2=sigma2,
                        start=start,out=out,eps=eps,max.iter=max.iter, gpu=gpu,
                        pbar=pbar,seed=seed, ...)
  }
  else if (method=="als"){
    fit=BIDIFAC.als(X1=X1,X2=X2,noise.est=noise.est, sigma1=sigma1,sigma2=sigma2,
                    start=start,out=out,eps=eps,max.iter=max.iter, gpu=gpu,
                    pbar=pbar,seed=seed, ...)
  }
  return(fit)
...
impute.BIDIFAC=function(X1,X2, noise.est="RMT", sigma1=NULL,sigma2=NULL,
                        method="nuclear", start=NULL, max.iter.impute=20, 
                        eps.impute=1e-3, pbar=TRUE, ...){
  X1.original=X1
  X2.original=X2
  ...
  while (bool2){
    ...
    fit<-BIDIFAC(X1 = list(X11,X12), X2 = list(X21, X22),noise.est = NULL, 
                 ...
                 start=start, method=method,pbar = FALSE, ...)
    start=fit$out
